...
export const api = {
  ...
  createSuccessorTask: (sourceTaskId: string, input: CreateTaskInput) => request<{ task: Task; dependency: Dependency }>(`/api/tasks/${sourceTaskId}/successors`, { method: 'POST', ...json(input) }),
